...
const toastContainerClassName = 'fixed inset-x-0 bottom-4 z-100 mx-auto h-12 flex items-center w-full max-w-xs p-4 space-x-4 text-buttonText bg-background divide-x divide-hint rounded-lg shadow select-none cursor-pointer transition-transform'
